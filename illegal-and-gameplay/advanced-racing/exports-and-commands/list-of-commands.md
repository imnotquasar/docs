...
<table><thead><tr><th width="342">Command</th><th>Description</th></tr></thead><tbody><tr><td>/openracingui</td><td>You must enable Config.AccessTabletWithKey.</td></tr><tr><td>/race_cams</td><td>Requires using Config.Debug for this.</td></tr></tbody></table>
