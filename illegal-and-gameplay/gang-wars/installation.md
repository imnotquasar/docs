...
{% embed url="https://github.com/meta-hub/meta_libs/releases" %}
{% endstep %}

{% step %}
### progressbar

{% embed url="https://github.com/quasar-scripts/progressbar" %}
{% endstep %}
{% endstepper %}
...
This asset must always be started below your framework and inventory. Failure to do so may result in functionality issues or critical errors. To ensure smooth operation and proper initialization, it is recommended to start the entire download folder using "ensure \[gangwars]" in your server.cfg.
