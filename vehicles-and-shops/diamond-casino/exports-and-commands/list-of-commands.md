...
<table><thead><tr><th width="252">Command</th><th>Description</th></tr></thead><tbody><tr><td>/givechips [id] [amount]</td><td>Administrative command to give chips, membership required.</td></tr><tr><td>/casino</td><td>Command for the worker to open the job menu.</td></tr></tbody></table>
