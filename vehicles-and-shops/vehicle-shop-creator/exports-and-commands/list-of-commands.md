...
<table><thead><tr><th width="342">Command</th><th>Description</th></tr></thead><tbody><tr><td>/vehicleshop</td><td>Open creator menu.</td></tr><tr><td>/opendealership</td><td>Open the job menu (player).</td></tr></tbody></table>
