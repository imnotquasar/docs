...
<table><thead><tr><th width="235">Command</th><th>Description</th></tr></thead><tbody><tr><td>/givekey [id]</td><td>Command for administrative use, gives keys to the player but must be inside a vehicle.</td></tr></tbody></table>
