...
<table><thead><tr><th width="342">Command</th><th>Description</th></tr></thead><tbody><tr><td>/crafting_creator</td><td>Command to open the creation menu.</td></tr></tbody></table>
