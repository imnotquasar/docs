...
<table><thead><tr><th width="342">Command</th><th>Description</th></tr></thead><tbody><tr><td>/addslot [id]</td><td>Add slot to a player.</td></tr><tr><td>/qs:logout</td><td>Command editable from config.lua, logout.</td></tr></tbody></table>
