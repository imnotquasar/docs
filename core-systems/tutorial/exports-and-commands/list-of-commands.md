...
<table><thead><tr><th width="342">Command</th><th>Description</th></tr></thead><tbody><tr><td>/tutorial</td><td>Configurable in config.lua</td></tr><tr><td>/resettutorial</td><td>Configurable in config.lua too</td></tr></tbody></table>
